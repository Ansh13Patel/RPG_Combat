...
public: \
	DECLARE_CLASS(AFloatingPlatform, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/RPGCombat"), NO_API) \
...
template<> RPGCOMBAT_API UClass* StaticClass<class AFloatingPlatform>();
