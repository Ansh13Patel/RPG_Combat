...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_ALevelTransitionVolume_Statics::NewProp_TransitionLevelName = { "TransitionLevelName", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ALevelTransitionVolume, TransitionLevelName), METADATA_PARAMS(Z_Construct_UClass_ALevelTransitionVolume_Statics::NewProp_TransitionLevelName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALevelTransitionVolume_Statics::NewProp_TransitionLevelName_MetaData)) };
	...
	IMPLEMENT_CLASS(ALevelTransitionVolume, 1503379983);
	template<> RPGCOMBAT_API UClass* StaticClass<ALevelTransitionVolume>()
	{
		return ALevelTransitionVolume::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ALevelTransitionVolume(Z_Construct_UClass_ALevelTransitionVolume, &ALevelTransitionVolume::StaticClass, TEXT("/Script/RPGCombat"), TEXT("ALevelTransitionVolume"), false, nullptr, nullptr, nullptr);
